...
use WhatsApp\StreamEncryption\Models\DecryptWhatsAppStreamVideo;
...
#[CoversClass(DecryptWhatsAppStreamVideo::class)]
class DecryptWhatsAppStreamVideoTest extends TestCase
{
    ...
    public function testExecExceptionStreams()
    {
        ...
        $instance = new DecryptWhatsAppStreamVideo($this->tempFileRead, $this->tempFileWrite);
