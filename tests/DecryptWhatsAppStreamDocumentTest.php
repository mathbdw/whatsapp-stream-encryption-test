...
use WhatsApp\StreamEncryption\Models\DecryptWhatsAppStreamDocument;
...
#[CoversClass(DecryptWhatsAppStreamDocument::class)]
class DecryptWhatsAppStreamDocumentTest extends TestCase
{
    ...
    public function testExecExceptionStreams()
    {
        ...
        $instance = new DecryptWhatsAppStreamDocument($this->tempFileRead, $this->tempFileWrite);
