...
use WhatsApp\StreamEncryption\Models\EncryptWhatsAppStreamAudio;
...
#[CoversClass(EncryptWhatsAppStreamAudio::class)]
class EncryptWhatsAppStreamAudioTest extends TestCase
{
    ...
    public function testExecExceptionStreams()
    {
        ...
        $instance = new EncryptWhatsAppStreamAudio($this->tempFileRead, $this->tempFileWrite);
        $instance->exec();
    }
