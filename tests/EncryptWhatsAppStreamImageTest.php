...
use WhatsApp\StreamEncryption\Models\EncryptWhatsAppStreamImage;
...
#[CoversClass(EncryptWhatsAppStreamImage::class)]
class EncryptWhatsAppStreamImageTest extends TestCase
{
    ...
    public function testExecExceptionStreams()
    {
        ...
        $instance = new EncryptWhatsAppStreamImage($this->tempFileRead, $this->tempFileWrite);
        $instance->exec();
    }
